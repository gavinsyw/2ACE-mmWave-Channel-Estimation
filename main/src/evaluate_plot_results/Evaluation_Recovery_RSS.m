function Evaluation_result = Evaluation_Recovery_RSS(recoveredSig,L,H,Sparse_Channel_Representation,ULA,SNR,Mtr,noise_power,U)
...
vecH_Estimated = Sparse_Channel_Representation.AD*recoveredSig(:,1);

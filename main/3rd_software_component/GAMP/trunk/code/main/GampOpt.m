classdef GampOpt
	...
	% There are two versions:
        ...
        % If desired, custom error functions can be used to monitor the
        % progress of GAMP during runtime.
        % One can specify either of two functions:
        errFcn1 = [];
        % called as err1 = errFcn1(xhat,Axhat,rhat,phat);
        errFcn2 = [];
        % called as err2 = errFcn2(xhat,Axhat,rhat,phat);

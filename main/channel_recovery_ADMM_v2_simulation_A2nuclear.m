...
function [H_amp,H_angle] = channel_recovery_ADMM_v2_simulation_A2nuclear(tx_ant_num, rx_ant_num, cb_amp, cb_angle, rss_final, seed_id)
    ...
    for i = 1: length(M)
        ...
        % Recovery
        recovered_Channel = Recover_Channel_nuclear(measurements, beams, Method, ...

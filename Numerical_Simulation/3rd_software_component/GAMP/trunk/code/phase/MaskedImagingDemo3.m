...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 % run PR-GAMP
 tstartGAMP = tic;
 [xhat,out_pr] = prGAMP3(y_abs,A,opt_pr,opt_gamp);
...
%T=100; mse=nan(1,T); time=nan(1,T); for t=1:T, MaskedImagingDemo3; mse(t)=mseGAMPdB; time(t)=timeGAMP; end; mse_worst = max(mse), median(time)

...
% Create the (basic, non-group) sparsity estimator
inputEst2 = SparseScaEstim(inputEst1, p1Nom(1));
...
for itest = 1:ntest
    ...
    for imeth = 1:nmeth
        ...
        elseif (meth == AMP_METH)

            xhat = gampEst(inputEst2, outputEst, Aop, opt);
